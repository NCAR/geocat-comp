...
def rcm2points(lat2d, lon2d, fi, lat1d, lon1d, msg=None, meta=False):
     ...
     Examples:
         ...
         .. code-block:: python
             ...
             ht_rect = geocat.comp.rcm2points(lat2D_curv, lon2D_curv, ht_curv, newlat1D_points, newlon1D_points)
     ...
     if isinstance(fi_data, np.ndarray):
         fo = _ncomp._rcm2points(lat2d, lon2d, fi_data, lat1d, lon1d, msg)
     else:
         raise TypeError
