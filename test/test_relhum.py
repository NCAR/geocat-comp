...
class Test_relhum(unittest.TestCase):
    ...
    def test_list_input(self):
        ...
        assert np.allclose(relhum(t_def, q_def, p_def), rh_gt_2, atol=0.1)
    ...
    def test_dask_unchunked_input(self):
        p = da.from_array(p_def)
        t = da.from_array(t_def)
        q = da.from_array(q_def)
    ...
    def test_dask_chunked_input(self):
        ...
        t = da.from_array(t_def, chunks="auto")
        q = da.from_array(q_def, chunks="auto")
