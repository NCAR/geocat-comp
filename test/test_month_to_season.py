...
class Test_month_to_season(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.ds1 = get_fake_dataset(start_month='2000-01',
                                    nmonths=12,
                                    nlats=1,
                                    nlons=1)

        # Create another dataset for the year 2001.
        self.ds2 = get_fake_dataset(start_month='2001-01',
                                    nmonths=12,
                                    nlats=1,
                                    nlons=1)
        ...
        self.partial_year_dataset = get_fake_dataset(start_month='2000-01',
                                                     nmonths=13,
                                                     nlats=1,
                                                     nlons=1)
        ...
        self.complex_dataset = get_fake_dataset(start_month='2001-01',
                                                nmonths=12,
                                                nlats=10,
                                                nlons=10)
    ...
    def test_custom_time_coordinate(self):
        season_ds = month_to_season(self.custom_time_dataset,
                                    'JFM',
