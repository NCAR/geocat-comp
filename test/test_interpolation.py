...
try:
    ...
    ds_atmos = xr.open_dataset("test/data/atmos.nc", decode_times=False)
...
class Test_delta_pressure_hybrid:
    ...
    def dph_out(self):
        ...
        try:
            return xr.open_dataarray("./data/dpres_hybrid_ccm_output.nc")
        except Exception:
            return xr.open_dataarray("test/data/dpres_hybrid_ccm_output.nc")
...
class Test_interp_hybrid_to_pressure_extrapolate:
    ...
    def ds_out(self):
        ...
        try:
            return xr.open_dataset(
                "test/data/vinth2p_ecmwf_output.nc", decode_times=False
            )
        except Exception:
            return xr.open_dataset("./data/vinth2p_ecmwf_output.nc", decode_times=False)
...
class Test_interp_sigma_to_hybrid:
    ...
    def ds_ps(self):
        ...
        try:
            ...
            return xr.open_dataset("test/data/ps.89335.1.nc", decode_times=False)
    ...
    def ds_out(self):
        ...
        try:
            return xr.open_dataset(
                "./data/sigma2hybrid_output.nc"
            )  # Generated by running ncl_tests/test_sigma2hybrid.ncl
        except Exception:
            return xr.open_dataset("test/data/sigma2hybrid_output.nc")
...
class TestPressureAtHybridLevels:
    ...
    def uxds(self):
        ...
        try:
            return ux.open_dataset("./data/ux-grid.nc", "./data/ux-data.nc")
        except FileNotFoundError:
            return ux.open_dataset("test/data/ux-grid.nc", "test/data/ux-data.nc")
