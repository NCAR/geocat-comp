...
class TestDaskCompat:
    ...
    def test_actual_saturation_vapor_pressure_dask(self):
        ...
        out = actual_saturation_vapor_pressure(tempf, tfill=1.0000000e+20)
    ...
    def test_saturation_vapor_pressure_dask(self):
        ...
        out = saturation_vapor_pressure(tempf, tfill=1.0000000e+20)
    ...
    def test_interp_hybrid_to_pressure_dask(self):
        ...
        out = interp_hybrid_to_pressure(data,
                                        ps,
                                        ds_atmos.hyam,
                                        ds_atmos.hybm,
                                        p0=1000 * 100,
