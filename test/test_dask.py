...
class TestDaskCompat_meteorology:
    ...
    def test_psychrometric_constant_dask(self):
        ...
        try:
            ...
            ncl_gt = xr.open_dataarray("./data/psychro_fao56_output.nc").values
        except FileNotFoundError:
            ncl_gt = xr.open_dataarray("test/data/psychro_fao56_output.nc").values
...
class TestDaskCompat_gradient:
    ...
    def test_gradient_dask(self):
        test_data = (
            xr.load_dataset('test/data/gradient_test_data.nc')
            .to_array()
            .squeeze()
            .chunk(10)
        )
...
class TestDaskCompat_interpolation:
    ...
    def ds_atmos(self):
        ...
        try:
            ...
            return xr.open_dataset("test/data/atmos.nc", decode_times=False)
