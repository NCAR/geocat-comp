...
class TestDaskCompat:
    ...
    def test_actual_saturation_vapor_pressure_dask(self):
        ...
        try:
            ...
            ncl_gt = xr.open_dataarray(
                "test/satvpr_tdew_fao56_output.nc").values
    ...
    def test_saturation_vapor_pressure_dask(self):
        ...
        try:
            ...
            ncl_gt = xr.open_dataarray(
                "test/satvpr_temp_fao56_output.nc").values
    ...
    def test_saturation_vapor_pressure_slope_dask(self):
        ...
        try:
            ...
            ncl_gt = xr.open_dataarray(
                "test/satvpr_slope_fao56_output.nc").values
    ...
    def test_interp_hybrid_to_pressure_dask(self):
        pres3d = np.asarray([1000, 950, 800, 700, 600, 500, 400, 300, 200
                            ]) * 100
        ...
        assert isinstance(out.data, dask.array.Array)
        assert np.allclose(out.mean(dim='lon'),
                           ds_out.uzon,
                           atol=5e-6,
                           equal_nan=True)
