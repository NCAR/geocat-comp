...
try:
    ds_out = xr.open_dataset("vinth2p_output.nc")  # Generated by running ncl_tests/vinth2p_test_conwomap_5.ncl on atmos.nc
except:
...
class Test_interp_hybrid_to_pressure(TestCase):
    ...
    def test_interp_hybrid_to_pressure_atmos(self):
        u_int = geocat.comp.interp_hybrid_to_pressure(_data, _ps[0, :, :], _hyam, _hybm, p0=_p0, new_levels=_pres3d,
                                                      method="log")
