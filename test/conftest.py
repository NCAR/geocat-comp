...
def vinth2p_output():
    ...
    try:
        return xr.open_dataset("./data/vinth2p_output.nc")
    except FileNotFoundError:
        return xr.open_dataset("test/data/vinth2p_output.nc")
...
def p_out():
    try:
        return xr.open_dataset(
            "./data/pres_hybrid_ccm_output.nc"
        )  # Generated by running ncl_tests/test_pres_hybrid_ccm.ncl
    except Exception:
        return xr.open_dataset("test/data/pres_hybrid_ccm_output.nc")
