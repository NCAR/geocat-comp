...
class Test_rcm2points_float64(ut.TestCase):
    ...
    def test_rcm2points_float64_nom_opt0(self):
        np.testing.assert_array_almost_equal(fo_nom_opt0_expected, geocat.comp.rcm2points(lat2d, lon2d, fi_nom.astype(np.float64), lat, lon, opt=0))

    def test_rcm2points_float64_nom_opt2(self):
        np.testing.assert_array_almost_equal(fo_nom_opt2_expected, geocat.comp.rcm2points(lat2d, lon2d, fi_nom.astype(np.float64), lat, lon, opt=2))

    def test_rcm2points_float64_nan_opt0(self):
        np.testing.assert_array_almost_equal(fo_nan_opt0_expected, geocat.comp.rcm2points(lat2d, lon2d, fi_nan.astype(np.float64), lat, lon, opt=0))

    def test_rcm2points_float64_nan_opt2(self):
        np.testing.assert_array_almost_equal(fo_nan_opt2_expected, geocat.comp.rcm2points(lat2d, lon2d, fi_nan.astype(np.float64), lat, lon, opt=2))

    def test_rcm2points_float64_msg_opt0(self):
        np.testing.assert_array_almost_equal(fo_msg_opt0_expected, geocat.comp.rcm2points(lat2d, lon2d, fi_msg.astype(np.float64), lat, lon, opt=0, msg=msg64))

    def test_rcm2points_float64_msg_opt2(self):
        np.testing.assert_array_almost_equal(fo_msg_opt2_expected, geocat.comp.rcm2points(lat2d, lon2d, fi_msg.astype(np.float64), lat, lon, opt=2, msg=msg64))
...
class Test_rcm2points_float32(ut.TestCase):
    ...
    def test_rcm2points_float32_nom_opt0(self):
        np.testing.assert_array_almost_equal(fo_nom_opt0_expected, geocat.comp.rcm2points(lat2d, lon2d, fi_nom.astype(np.float32), lat, lon, opt=0))

    def test_rcm2points_float32_nom_opt2(self):
        np.testing.assert_array_almost_equal(fo_nom_opt2_expected, geocat.comp.rcm2points(lat2d, lon2d, fi_nom.astype(np.float32), lat, lon, opt=2))

    def test_rcm2points_float32_nan_opt0(self):
        np.testing.assert_array_almost_equal(fo_nan_opt0_expected, geocat.comp.rcm2points(lat2d, lon2d, fi_nan.astype(np.float32), lat, lon, opt=0))

    def test_rcm2points_float32_nan_opt2(self):
        np.testing.assert_array_almost_equal(fo_nan_opt2_expected, geocat.comp.rcm2points(lat2d, lon2d, fi_nan.astype(np.float32), lat, lon, opt=2))

    def test_rcm2points_float32_msg_opt0(self):
        np.testing.assert_array_almost_equal(fo_msg_opt0_expected, geocat.comp.rcm2points(lat2d, lon2d, fi_msg.astype(np.float32), lat, lon, opt=0, msg=msg32))

    def test_rcm2points_float32_msg_opt2(self):
        np.testing.assert_array_almost_equal(fo_msg_opt2_expected, geocat.comp.rcm2points(lat2d, lon2d, fi_msg.astype(np.float32), lat, lon, opt=2, msg=msg32))
