...
class TestDeltaPressure(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.surface_pressure_1D_da = xr.DataArray(cls.surface_pressure_1D,
                                                  coords=coords,
                                                  dims=dims,
                                                  attrs=attrs)
        ...
        dims = ["lat", "lon"]
        cls.surface_pressure_2D_da = xr.DataArray(cls.surface_pressure_2D,
                                                  coords=coords,
                                                  dims=dims,
                                                  attrs=attrs)
    ...
    def test_deltapressure_1D(self):
        ...
        delta_pressure = calc_deltapressure(pressure_lev,
    ...
    def test_negative_pressure_warning(self):
        ...
        with self.assertWarns(Warning):
            delta_pressure = calc_deltapressure(pressure_lev_negative,
                                                self.surface_pressure_scalar)
