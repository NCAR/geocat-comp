...
class Test_heat_index:
    ...
    def hi_nws(self):
        try:
            return np.genfromtxt("./data/heat-index.csv", delimiter=",").T
        except Exception:
            return np.genfromtxt("test/data/heat-index.csv", delimiter=",").T
    ...
    def ncl_gt(self):
        ...
        try:
            return xr.open_dataarray(
                "./data/satvpr_tdew_fao56_output.nc"
            ).values  # Generated by running ncl_tests/test_satvpr_tdew_fao56.ncl
        except Exception:
            return xr.open_dataarray("test/data/satvpr_tdew_fao56_output.nc").values
...
class Test_max_daylight:
    ...
    def ncl_gt(self):
        ...
        try:
            return xr.open_dataarray(
                "./data/max_daylight_test.nc"
            ).values  # Generated by running ncl_tests/test_max_daylight.ncl
        except Exception:
            return xr.open_dataarray("test/data/max_daylight_test.nc").values
...
class Test_psychrometric_constant:
    ...
    def ncl_gt(self):
        ...
        try:
            return xr.open_dataarray(
                "./data/psychro_fao56_output.nc"
            ).values  # Generated by running ncl_tests/test_psychro_fao56.ncl
        except Exception:
            return xr.open_dataarray("test/data/psychro_fao56_output.nc").values
...
class Test_saturation_vapor_pressure:
    ...
    def ncl_gt(self):
        ...
        try:
            return xr.open_dataarray(
                "./data/satvpr_temp_fao56_output.nc"
            ).values  # Generated by running ncl_tests/test_satvpr_temp_fao56.ncl
        except Exception:
            return xr.open_dataarray("test/data/satvpr_temp_fao56_output.nc").values
...
class Test_saturation_vapor_pressure_slope:
    ...
    def ncl_gt(self):
        ...
        try:
            return xr.open_dataarray(
                "./data/satvpr_slope_fao56_output.nc"
...
class Test_zonal_meridional_psi:
    ...
    def uxds_plev(self):
        ...
        try:
            return ux.open_dataset("./data/grid_subset.nc", "./data/plev_subset.nc")
    ...
    def uxds_hybrid(self):
        ...
        try:
            return ux.open_dataset("./data/grid_subset.nc", "./data/hybrid_subset.nc")
        except FileNotFoundError:
            return ux.open_dataset(
                "test/data/grid_subset.nc", "test/data/hybrid_subset.nc"
            )
