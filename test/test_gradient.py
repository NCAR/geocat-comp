...
class Test_Gradient(unittest.TestCase):
    ...
    test_coords_2d_lon = None
    test_coords_2d_lat = None
    ...
    def setUpClass(cls):
        ...
        cls.test_coords_2d_lon, cls.test_coords_2d_lat = np.meshgrid(cls.test_coords_1d_lon, cls.test_coords_1d_lat)
        cls.test_data_xr_2d_coords = xr.DataArray(cls.test_data_xr, coords={'lon':cls.test_coords_2d_lon, 'lat': cls.test_coords_2d_lat})
        cls.test_coords_1d_lon_np = cls.test_coords_1d_lon.values
        cls.test_coords_1d_lat_np = cls.test_coords_1d_lat.values
        cls.test_coords_2d_lon_np = cls.test_coords_2d_lon.values
        cls.test_coords_2d_lat_np = cls.test_coords_2d_lat.values
    ...
    def test_gradient_axis0_xr_2d_nocoords(self):
        self.results = gradient(
            self.test_data_xr_nocoords,
            self.test_coords_2d_lon,
            self.test_coords_2d_lat)
        self.results_axis0 = self.results[0]
        self.results_axis1 = self.results[1]
        np.testing.assert_almost_equal(
            self.results_axis0.values,
